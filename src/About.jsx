...
function About() {
    return (
        <div id="wrapper_about" className="backInRight">
            ...
            Diplômé (septembre 2017) du programme Grande Ecole de <span>Grenoble Ecole de Management.</span> J'ai commencé ma carrière sur des postes commerciaux et de gestion de projet dans le milieu des starts up. En janvier 2020, J'ai entamé une <span>reconversion professionnelle pour devenir developpeur web </span>en suivant le bootcamp d'<span>Ironhack</span>.<br/> <br/>
